...
<div class="restaurant-item">
    <div class="restaurant-item_header">
        <img  class="restaurant-item_thumbnail" data-src="${CONFIG.BASE_IMAGE_LARGE_URL + restaurant.pictureId}" src="${CONFIG.BASE_IMAGE_LARGE_URL + restaurant.pictureId}" alt="${restaurant.name}">
